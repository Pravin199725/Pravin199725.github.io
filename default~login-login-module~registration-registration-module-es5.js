...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~login-login-module~registration-registration-module"], {
  /***/
  ...
  /*! exports provided: AmazonLoginProvider, BaseLoginProvider, DummyLoginProvider, FacebookLoginProvider, GoogleLoginProvider, SocialAuthService, SocialLoginModule, SocialUser */

  /***/
  function node_modulesAngularxSocialLogin__ivy_ngcc__Fesm2015AngularxSocialLoginJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(SocialAuthService, [{
        ...
        value: function initialize(config) {
          ...
          config.providers.forEach(function (item) {
            _this42.providers.set(item.id, item.provider);
          });
          Promise.all(Array.from(this.providers.values()).map(function (provider) {
            return provider.initialize();
          })).then(function () {
            _this42.initialized = true;

            _this42._initState.next(_this42.initialized);

            _this42._initState.complete();

            if (_this42.autoLogin) {
              var loginStatusPromises = [];
              var loggedIn = false;

              _this42.providers.forEach(function (provider, key) {
        ...
        value: function signIn(providerId, signInOptions) {
          ...
          return new Promise(function (resolve, reject) {
            if (!_this43.initialized) {
              reject(SocialAuthService.ERR_NOT_INITIALIZED);
            } else {
              var providerObject = _this43.providers.get(providerId);
        ...
        value: function signOut() {
          ...
          return new Promise(function (resolve, reject) {
            if (!_this44.initialized) {
              reject(SocialAuthService.ERR_NOT_INITIALIZED);
            } else if (!_this44._user) {
              reject(SocialAuthService.ERR_NOT_LOGGED_IN);
            } else {
              var providerId = _this44._user.provider;

              var providerObject = _this44.providers.get(providerId);
    ...
    var DummyLoginProvider = /*#__PURE__*/function (_BaseLoginProvider) {
      _inherits(DummyLoginProvider, _BaseLoginProvider);

      var _super18 = _createSuper(DummyLoginProvider);
      ...
      function DummyLoginProvider(dummy) {
        ...
        _this45 = _super18.call(this);

        if (dummy) {
          _this45.dummy = dummy;
        } else {
          _this45.dummy = DummyLoginProvider.DEFAULT_USER;
        } // Start not logged in


        _this45.loggedIn = false;
        return _this45;
      }
      ...
      _createClass(DummyLoginProvider, [{
        ...
        value: function signIn() {
          ...
          return new Promise(function (resolve, reject) {
            _this47.loggedIn = true;
            resolve(_this47.dummy);
          });
        }
      }, {
        key: "signOut",
    ...
    var GoogleLoginProvider = /*#__PURE__*/function (_BaseLoginProvider2) {
      _inherits(GoogleLoginProvider, _BaseLoginProvider2);

      var _super19 = _createSuper(GoogleLoginProvider);
      ...
      function GoogleLoginProvider(clientId) {
        ...
        _this49.initOptions = initOptions;
        return _this49;
      }
      ...
      _createClass(GoogleLoginProvider, [{
        ...
        value: function initialize() {
          ...
          return new Promise(function (resolve, reject) {
            _this50.loadScript(GoogleLoginProvider.PROVIDER_ID, 'https://apis.google.com/js/platform.js', function () {
              gapi.load('auth2', function () {
                _this50.auth2 = gapi.auth2.init(Object.assign(Object.assign({}, _this50.initOptions), {
                  client_id: _this50.clientId
                }));

                _this50.auth2.then(function () {
                  resolve();
                })["catch"](function (err) {
                  reject(err);
                });
        ...
        value: function getLoginStatus() {
          ...
          return new Promise(function (resolve, reject) {
            if (_this51.auth2.isSignedIn.get()) {
              var user = new SocialUser();

              var profile = _this51.auth2.currentUser.get().getBasicProfile();

              var token = _this51.auth2.currentUser.get().getAuthResponse(true).access_token;

              var backendToken = _this51.auth2.currentUser.get().getAuthResponse(true).id_token;
        ...
        value: function signIn(signInOptions) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var promise = !offlineAccess ? _this52.auth2.signIn(signInOptions) : _this52.auth2.grantOfflineAccess(signInOptions);
            promise.then(function (response) {
              ...
              if (response && response.code) {
                ...
                var profile = _this52.auth2.currentUser.get().getBasicProfile();

                var token = _this52.auth2.currentUser.get().getAuthResponse(true).access_token;

                var backendToken = _this52.auth2.currentUser.get().getAuthResponse(true).id_token;
        ...
        value: function signOut(revoke) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (revoke) {
              signOutPromise = _this53.auth2.disconnect();
            } else {
              signOutPromise = _this53.auth2.signOut();
            }
    ...
    var FacebookLoginProvider = /*#__PURE__*/function (_BaseLoginProvider3) {
      ...
      var _super20 = _createSuper(FacebookLoginProvider);
      ...
      function FacebookLoginProvider(clientId) {
        ...
        _this54.clientId = clientId;
        _this54.initOptions = initOptions;
        return _this54;
      }
      ...
      _createClass(FacebookLoginProvider, [{
        ...
        value: function initialize() {
          ...
          return new Promise(function (resolve, reject) {
            _this55.loadScript(FacebookLoginProvider.PROVIDER_ID, "//connect.facebook.net/".concat(_this55.initOptions.locale, "/sdk.js"), function () {
              FB.init({
                appId: _this55.clientId,
                autoLogAppEvents: true,
                cookie: true,
                xfbml: true,
                version: _this55.initOptions.version
              });
              resolve();
            });
          });
          ...
          return new Promise(function (resolve, reject) {
            FB.getLoginStatus(function (response) {
              if (response.status === 'connected') {
                ...
                FB.api("/me?fields=".concat(_this56.initOptions.fields), function (fbUser) {
                  var user = new SocialUser();
                  user.id = fbUser.id;
    ...
    var AmazonLoginProvider = /*#__PURE__*/function (_BaseLoginProvider4) {
      ...
      var _super21 = _createSuper(AmazonLoginProvider);
      ...
      function AmazonLoginProvider(clientId) {
        ...
        _this57.clientId = clientId;
        _this57.initOptions = initOptions;
        return _this57;
      }
      ...
      _createClass(AmazonLoginProvider, [{
        ...
        value: function initialize() {
          ...
          window.onAmazonLoginReady = function () {
            amazon.Login.setClientId(_this58.clientId);
          };

          return new Promise(function (resolve, reject) {
            _this58.loadScript('amazon-login-sdk', 'https://assets.loginwithamazon.com/sdk/na/login1.js', function () {
              resolve();
            }, amazonRoot);
          });
        }
        ...
        value: function getLoginStatus() {
          ...
          return new Promise(function (resolve, reject) {
            var token = _this59.retrieveToken();
            ...
            amazon.Login.authorize(options, function (authResponse) {
              if (authResponse.error) {
                ...
                amazon.Login.retrieveProfile(authResponse.access_token, function (response) {
                  ...
                  _this60.persistToken(authResponse.access_token);
  ...
  function srcAppServicesApiApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        key: "get",
        value: function get(endpoint, params, headers, options) {
          if (headers || params) {
            var httpOptions = Object.assign({
        ...
        key: "post",
        value: function post(endpoint, body, headers) {
          var httpOptions = {
            headers: this.getHttpHeaders(headers)
          };
        ...
        key: "postByBody",
        value: function postByBody(endpoint, body, headers) {
        ...
        key: "put",
        value: function put(endpoint, body, headers) {
          var httpOptions = {
            headers: this.getHttpHeaders(headers)
          };
        ...
        key: "patch",
        value: function patch(endpoint, body, headers) {
          var httpOptions = {
            headers: this.getHttpHeaders(headers)
          };
        ...
        key: "getHttpParams",
        value: function getHttpParams(params) {
    ...
    ApiService.ɵfac = function ApiService_Factory(t) {
      return new (t || ApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_storage_storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"]));
    };
  ...
  function srcAppServicesAuthAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        ...
        key: "registration",
        value: function registration(userInfo) {
    ...
    AuthService.ɵfac = function AuthService_Factory(t) {
      return new (t || AuthService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]));
    };
...
//# sourceMappingURL=default~login-login-module~registration-registration-module-es5.js.map